      ...
      <nav className="fixed bottom-0 inset-x-0 z-30 bg-white border-t border-zinc-200 safe-area-bottom">
        <div className="flex items-stretch h-16">
          ...
          <Link
            href="/driver/profile"
            className={`flex flex-1 flex-col items-center justify-center gap-0.5 transition-colors ${
              pathname.startsWith('/driver/profile') ? 'text-zinc-900' : 'text-zinc-400 hover:text-zinc-600'
            }`}
          >
            <svg className="w-6 h-6" fill={pathname.startsWith('/driver/profile') ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
            </svg>
            <span className="text-[10px] font-medium leading-none">マイページ</span>
          </Link>
        </div>
      </nav>
    </div>
